...
Thanks to everyone who has contributed to LandmarkDiff.

## Maintainers

- **dreamlessx** - project lead, core architecture, training pipeline
...
|--------|----------|-------|
| Rathgeb et al. Plastic Surgery Database | Rathgeb, C., Dogan, D., Stockhardt, F., De Marsico, M., Busch, C. "Plastic Surgery: An Obstacle for Deep Face Recognition?" CVPRW 2020, pp. 3510-3517 | Evaluation of identity preservation across surgical procedures |

## How to Contribute

See [CONTRIBUTING.md](CONTRIBUTING.md) for guidelines. All contributions are welcome, from new procedure presets to documentation fixes. Check the [open issues](https://github.com/dreamlessx/LandmarkDiff-public/issues) for things to work on.
