...
**Clinical note:** The tight influence radius (15px) is important here because the periorbital region is small and spreading deformation too far creates unnatural cheek distortion.
...
### Submental / Chin
Upward-only displacement on chin landmarks (152, 148, 377, 378). Displacement: (0, -2.0 * scale) at 0.8x radius. No lateral movement because this region doesn't benefit from lateral tension.
