...
Any SD1.5-compatible checkpoint should work. SD2.x and SDXL checkpoints are not supported because the ControlNet is trained specifically for SD1.5's architecture.
